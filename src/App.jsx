...
function App() {
  ...
  useEffect(() => {
    const imgs = ["/trippy/assets/imgs/aboutHero.jpg", "/trippy/assets/imgs/contactAndSignHero.jpg", "/trippy/assets/imgs/homeHero.jpg", "/trippy/assets/imgs/log.jpg", "/trippy/assets/imgs/p1.jpg", "/trippy/assets/imgs/p2.jpg", "/trippy/assets/imgs/p3.jpg", "/trippy/assets/imgs/p4.jpg", "/trippy/assets/imgs/p5.jpg", "/trippy/assets/imgs/servicesHero.jpg"]
    let count = 0;
    imgs.forEach(src => {
      const img = new Image();
      img.src = src;
